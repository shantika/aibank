...
echo form_dropdown('job_position',$options, $customer['job_position']) ."</p>";
...
echo form_dropdown('job_contract_period',$options, $customer['job_contract_period']) ."</p>";
...
echo form_dropdown('resident',$options, $customer['resident']) ."</p>";

echo "<p><label for='vehicle'>Vehicle</label><br/>";
$options = array('3' => 'Car','2' => 'Motorbike','1' => 'Bicycle or social vehicles');
echo form_dropdown('vehicle',$options, $customer['vehicle']) ."</p>";
...
echo form_dropdown('education_level',$options, $customer['education_level']) ."</p>";
...
echo form_dropdown('insurance',$options, $customer['insurance']) ."</p>";

echo "<p><label for='is_marriage'>Marriage?</label><br/>";
$options = array('1' => 'Yes' , '2' => 'No');
echo form_dropdown('is_marriage',$options, $customer['is_marriage']) ."</p>";
...
$data = array('name'=>'money_owned','id'=>'money_owned','size'=>25, 'value' => $customer['money_owned']);
echo form_input($data) ."</p>";

echo "<p><label for='Income'>Income per month</label><br/>";
$data = array('name'=>'income','id'=>'income','size'=>25, 'value' => $customer['income']);
echo form_input($data) ."</p>";

echo "<p><label for='familiar_income'>Familiar Income per month</label><br/>";
$data = array('name'=>'familiar_income','id'=>'familiar_income','size'=>25, 'value' => $customer['familiar_income']);
echo form_input($data) ."</p>";

echo "<p><label for='Outcome'>Outcome per month</label><br/>";
$data = array('name'=>'outcome','id'=>'outcome','size'=>25, 'value' => $customer['outcome']);
echo form_input($data) ."</p>";
...
echo form_dropdown('status',$options, $customer['status']) ."</p>";
